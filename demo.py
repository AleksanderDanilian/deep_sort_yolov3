...
#                cv2.putText(frame, str(class_names[0]),(int(bbox[0]), int(bbox[1] -20)),0, 5e-3 * 150, (color),2)
        ...
        cv2.putText(frame, "Всего человек: "+str(count), (int(20), int(120)), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0,255,255), thickness = 2)
        cv2.putText(frame, "Человек в кадре: "+str(i), (int(20), int(80)), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0,255,255), thickness = 2)
